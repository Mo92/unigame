String imprintMarkdown = """# Impressum
...
Felix Jaron  
Julia Plöger  
Projektmanager des Projekts  
Frankfurt University of Applied Sciences  
Fachbereich _Wirtschaft und Recht_  
...
E-Mail: julia.ploeger@stud.fra-uas.de

**Vertreten durch:**

Das Projekt wird im Rahmen eines universitären Studienprojekts im Studiengang "International Finance" des Fachbereichs _Wirtschaft und Recht_ der Frankfurt University of Applied Sciences durchgeführt und wird durch folgende Projektmanager vertreten:

- Layla El-Fayoumi (Projektmanagerin)
- Felix Jaron (Projektmanager)
- Julia Plöger (Projektmanagerin)
...
Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: [https://ec.europa.eu/consumers/odr/](https://ec.europa.eu/consumers/odr/). Wir sind nicht verpflichtet und nicht bereit, an einem Streitbeilegungsverfahren vor einer Verbraucherschlichtungsstelle teilzunehmen.
""";

String privacyPolicyMarkdown = """# Datenschutzerklärung für das Uni-Projekt
